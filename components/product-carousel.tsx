        ...
        <div className="relative h-80 md:h-88 lg:h-96">
          ...
          >
            {extendedProducts.map((product, index) => (
              ...
              >
                <Card className="group hover:shadow-2xl transition-all duration-500 ease-out hover:-translate-y-2 bg-white/80 backdrop-blur-sm border-0 shadow-lg hover:shadow-blue-200/50 h-full">
                  <CardContent className="p-4 md:p-6">
                    <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl p-4 md:p-6 mb-4 h-32 md:h-40 lg:h-48 flex items-center justify-center relative overflow-hidden group-hover:from-blue-100 group-hover:to-indigo-200 transition-all duration-500">
                      ...
                      <img
                        ...
                        alt={product.name}
                        className="w-20 h-20 md:w-28 md:h-28 lg:w-32 lg:h-32 object-contain group-hover:scale-110 transition-all duration-500 ease-out relative z-10"
                      />
                    </div>
